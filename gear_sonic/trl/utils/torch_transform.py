...
# __file__ 기준 절대 경로 — CWD와 무관하게 항상 패키지 내부 파일을 참조
_DEFAULT_HUMAN_JOINTS_INFO_PATH = str(
    Path(__file__).parent.parent.parent / "data" / "human" / "human_joints_info.pkl"
)
...
def compute_human_joints(
    body_pose,
    global_orient,
    human_joints_info_path=_DEFAULT_HUMAN_JOINTS_INFO_PATH,
